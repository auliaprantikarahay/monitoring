...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Monitoring</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your monitoring</p>
	...
	<form action="" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="Username" name="txt_user" class="form-control" placeholder="Username">
        <span class="glyphicon glyphicon-user form-control-feedback"></div></td>
			</tr>
			<tr>
				<td>
      ...
      <div class="form-group has-feedback">
        ...
        <span class="glyphicon glyphicon-lock form-control-feedback"></span></div></td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="submit" name="btn_login"  class="btn btn-primary btn-block btn-flat" value="Login">
				</td>
			</tr>
		</table>
		</form><script src="<?php echo base_url() ;?>temp/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
